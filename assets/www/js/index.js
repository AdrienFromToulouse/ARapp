var app = {
    ...
    /**
     *
     *	This function gets called it the Wikitude SDK is able to start an ARchitect World 
     *  (the current device is supported by the Wikitude SDK)
     *
     */
    onDeviceIsReadyCallback : function()
    {
        // The device is able to launch ARchitect World, so we load the 'ARworld'
	WikitudePlugin.loadARchitectWorld("assets/world/ARworld.html");
        //WikitudePlugin.loadARchitectWorld("assets/world/tutorial1.html");
